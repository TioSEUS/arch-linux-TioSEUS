...
sudo pacman -S --noconfirm --needed $MICROCODE $GPU_PACKAGES ttf-jetbrains-mono-nerd ttf-font-awesome opendesktop-fonts swww waybar swaync kitty grim slurp jq nautilus discord sddm bluez bluez-utils networkmanager git fish mangohud fastfetch
...
mkdir -p ~/.config/hypr ~/.config/waybar ~/.config/walker ~/.config/fish ~/.config/fastfetch ~/.config/MangoHud ~/Pictures/Wallpapers
