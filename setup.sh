...
echo "📦 Instalando pacotes base e fontes..."
sudo pacman -S --noconfirm --needed \
    $MICROCODE $GPU_PACKAGES \
    ttf-jetbrains-mono-nerd ttf-font-awesome opendesktop-fonts \
    swww waybar swaync kitty grim slurp jq nautilus sddm bluez bluez-utils networkmanager git fish
...
yay -S --noconfirm walker-bin matugen-bin
